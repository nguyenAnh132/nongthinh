...
public class RestoreDiseaseUseCaseImpl implements RestoreDiseaseUseCase {
    ...
    public DiseaseView execute(UUID id) {
        ...
        support.requireStatus(disease, ReviewStatus.HIDDEN);
        CurrentUser currentUser = currentUserProvider.getCurrentUser();
        Instant now = clockProvider.now();

        disease.restorePublication(currentUser.getUserId(), now);
