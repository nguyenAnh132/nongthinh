package com.nongthinh.agri_catalog_service.infra.client.profile;

import com.nongthinh.agri_catalog_service.application.port.out.BrandAccessQuery;
import com.nongthinh.agri_catalog_service.application.view.BrandAccessView;
import com.nongthinh.agri_catalog_service.common.exception.ErrorCode;
import com.nongthinh.agri_catalog_service.configuration.BrandAccessProperties;
    ...
    public BrandAccessView getCurrentAccess() {
        ...
        try {
            ...
            if (response == null || !"1000".equals(response.code()) || response.result() == null) {
                throw new BusinessException(ErrorCode.BRAND_ACCESS_UNAVAILABLE);
            }
            ...
            throw new BusinessException(ErrorCode.BRAND_ACCESS_UNAVAILABLE, ex);
        }
    }
