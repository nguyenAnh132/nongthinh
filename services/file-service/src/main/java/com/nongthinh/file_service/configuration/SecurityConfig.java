...
import com.nongthinh.file_service.configuration.jwt.JwtBearerTokenResolver;
import com.nongthinh.file_service.configuration.property.AuthCookieProperties;
import lombok.RequiredArgsConstructor;

@Configuration
@EnableWebSecurity
@EnableMethodSecurity
@EnableConfigurationProperties({ApiKeyProperties.class, StorageProperties.class, FileUploadProperties.class,
