package com.nongthinh.file_service.configuration.jwt;
...
/**
 * Đọc JWT từ cookie HttpOnly {@code access_token} (giống profile/brand-service),
 * fallback sang header Authorization Bearer.
 */
@Component
