...
import com.nongthinh.file_service.common.exception.ErrorType;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException ex) {
        ...
        log.warn("[Presentation - MaxUploadSizeExceededException] Upload rejected | code={} maxUploadSize={}",
                errorCode.getCode(), ex.getMaxUploadSize());
        return error(errorCode, errorCode.getDefaultMessage());
    }
