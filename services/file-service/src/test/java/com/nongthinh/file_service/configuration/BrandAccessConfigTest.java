...
class BrandAccessConfigTest {
    ...
    private final BrandAccessConfig config = new BrandAccessConfig(access , mock(com.nongthinh.file_service.application.port.in.file.GetFileByIdUseCase.class));
    ...
    @Test
    void uploadsAreRestrictedByPurposeAndReviewState() {
        authenticate("ROLE_BRAND_PENDING");
        stub(false, true, true);
        assertTrue(upload("BUSINESS_LICENSE"));
        assertTrue(upload("BRAND_LOGO"));
        assertThrows(BusinessException.class, () -> upload("POST_IMAGE"));
        assertThrows(BusinessException.class, () -> upload("PRODUCT_IMAGE"));
        assertThrows(BusinessException.class, () -> upload("DIAGNOSIS_IMAGE"));
        stub(false, false, false);
        assertThrows(BusinessException.class, () -> upload("BUSINESS_LICENSE"));
        assertThrows(BusinessException.class, () -> upload("BRAND_BANNER"));
    }

    private boolean upload(String purpose) {
