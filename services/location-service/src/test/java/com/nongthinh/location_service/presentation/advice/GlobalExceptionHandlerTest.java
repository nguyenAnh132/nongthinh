...
class GlobalExceptionHandlerTest {
    ...
    static Stream<Arguments> exceptions() {
        return Stream.of(
                Arguments.of(new BusinessException(ErrorCode.PROVINCE_NOT_FOUND), 404,
                        ErrorCode.PROVINCE_NOT_FOUND, "BusinessException", Level.WARN),
    ...
    void beanValidationUsesConfiguredErrorCode(String body, ErrorCode errorCode) throws Exception {
    ...
    static Stream<Arguments> invalidBodies() {
        return Stream.of(
                Arguments.of("{}", ErrorCode.PROVINCE_NAME_REQUIRED),
                Arguments.of("{\"name\":\"\"}", ErrorCode.PROVINCE_NAME_REQUIRED));
    }
    ...
    record TestRequest(@NotBlank(message = "PROVINCE_NAME_REQUIRED") String name) {
    }
}
