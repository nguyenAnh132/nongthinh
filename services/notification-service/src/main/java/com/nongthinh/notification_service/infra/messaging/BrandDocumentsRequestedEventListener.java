...
import com.nongthinh.notification_service.application.event.BrandDocumentsRequestedEvent;
...
@Slf4j
public class BrandDocumentsRequestedEventListener {
    ...
    public void consume(String message) {
        ...
        log.info(
                "Received BrandDocumentsRequestedEvent: eventId={}, brandProfileId={}, email={}",
                event.eventId(),
        ...
        sendTemplatedEmailUseCase.execute(new SendTemplatedEmailCommand(
                EmailPurposeConstant.BRAND_DOCUMENTS_REQUESTED,
                event.userId(),
                event.representativeEmail(),
                Map.of(
