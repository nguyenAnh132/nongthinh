...
public class CreatePostMediaUseCaseImpl implements CreatePostMediaUseCase {
    ...
    @Override
    @Transactional
    public PostMediaView execute(UUID postId, CreatePostMediaCommand command) {
        if (command == null) {
