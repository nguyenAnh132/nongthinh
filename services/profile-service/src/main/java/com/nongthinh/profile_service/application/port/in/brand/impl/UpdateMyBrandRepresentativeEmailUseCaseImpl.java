...
public class UpdateMyBrandRepresentativeEmailUseCaseImpl implements UpdateMyBrandRepresentativeEmailUseCase {
    ...
    @Override
    public BrandProfileView execute(String representativeEmail) {
        ...
        profile.updateRepresentativeEmail(representativeEmail, clockProvider.now());
