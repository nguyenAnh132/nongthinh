...
public class UpdateMyBrandRepresentativePhoneUseCaseImpl implements UpdateMyBrandRepresentativePhoneUseCase {
    ...
    @Override
    public BrandProfileView execute(String representativePhone) {
        ...
        profile.updateRepresentativePhone(representativePhone, clockProvider.now());
