package com.nongthinh.rice_disease_diagnosis_service.infra.client.profile;

import com.nongthinh.rice_disease_diagnosis_service.application.port.out.BrandAccessQuery;
import com.nongthinh.rice_disease_diagnosis_service.application.view.BrandAccessView;
import com.nongthinh.rice_disease_diagnosis_service.common.exception.ErrorCode;
import com.nongthinh.rice_disease_diagnosis_service.configuration.BrandAccessProperties;
    ...
    public BrandAccessView getCurrentAccess() {
        ...
        try {
            ...
            if (response == null || !"1000".equals(response.code()) || response.result() == null) {
                throw new DiagnosisException(ErrorCode.BRAND_ACCESS_UNAVAILABLE);
            }
            ...
            throw new DiagnosisException(ErrorCode.BRAND_ACCESS_DENIED, ex);
        } catch (RestClientException ex) {
            throw new DiagnosisException(ErrorCode.BRAND_ACCESS_UNAVAILABLE, ex);
        }
    }
